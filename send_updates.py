...
😷 {date_data["change_cases"]} new cases, 🪦 {date_data["change_fatalities"]} new fatalities,
💉 {date_data["change_vaccinations"]} new vaccinations, {date_data["change_boosters_1"]} new boosters,
{date_data["change_vaccinated"]} people newly vaccinated,
{date_data["total_vaccinated"]} total vaccinated, {round((date_data["total_vaccinated"]*100.00)/4634349, 2)}% of eligible people.
